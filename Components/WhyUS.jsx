        ...
        <div className=" max-w-7xl mx-auto px-1 sm:px-2 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-3 items-center justify-between  lg:space-x-4">
            <div className="stat">
              ...
              <div className="stat-title text-primary lg:text-black">Total Sales</div>
              <div className="stat-value text-secondary lg:text-black">$1.5M</div>
              <div className="stat-desc text-primary lg:text-black">This Quarter</div>
            </div>
            <div className="stat">
              <div className="stat-figure text-secondary">
              ...
              <div className="stat-title text-primary lg:text-black">New Clients</div>
              <div className="stat-value text-secondary lg:text-black">457</div>
              <div className="stat-desc text-primary lg:text-black">This Month</div>
            </div>
            <div className="stat">
              <div className="stat-figure text-secondary">
              ...
              <div className="stat-title text-primary lg:text-black">Customer Satisfaction</div>
              <div className="stat-value text-secondary lg:text-black">95%</div>
              <div className="stat-desc text-primary lg:text-black">Highest Rating</div>
            </div>
          </div>
        </div>
      </div>
